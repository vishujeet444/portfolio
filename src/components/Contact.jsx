...
function InputField({ label, type = 'text', name, value, onChange, multiline, placeholder, required }) {
  ...
  return (
    <div className="relative group">
      <label
        htmlFor={id}
        className="type-label block mb-3 transition-colors duration-300"
        style={{ color: focused ? 'var(--neon)' : 'rgba(255,255,255,0.18)' }}
      >
        {label}
      </label>
      {multiline ? (
      ...
      <div
        ...
        style={{
          width: focused ? '100%' : '0%',
          background: 'var(--neon)',
          boxShadow: focused ? '0 0 10px var(--emerald-glow)' : 'none',
        }}
      />
    </div>
  );
...
export default function Contact() {
  ...
  return (
    <section id="contact" ref={ref} className="relative z-10 section-pad">
      <div
        className="absolute inset-0 pointer-events-none"
        style={{
          background: 'radial-gradient(ellipse 70% 50% at 50% 100%, rgba(45,160,110,0.1) 0%, transparent 55%)',
        }}
      />
      <div
        className="absolute inset-0 pointer-events-none opacity-40"
        style={{
          background: 'radial-gradient(ellipse 50% 40% at 85% 30%, rgba(110,196,212,0.06) 0%, transparent 60%)',
        }}
      />
      ...
      <div className="section-container relative">
        ...
        <div className="contact-layout">
              ...
              {[
                ...
                return (
                  ...
                  >
                    ...
                    <span
                      className="type-body-sm transition-colors duration-300 group-hover:text-white/80"
              ...
              <div className="flex flex-col gap-3">
                {SOCIAL_LINKS.map((link) => (
                  ...
                  >
                    ...
                    <div>
                      <div className="type-body-sm mb-1 transition-colors duration-300 group-hover:text-[var(--neon)]">
                        {link.label}
                      </div>
                      <div className="type-label !text-[0.65rem]">
                        {link.desc}
                      </div>
                    </div>
                  </a>
          ...
          >
            <div className="glass-stat !p-10 md:!p-12 relative overflow-hidden">
              <div
                className="absolute -top-20 -right-20 w-40 h-40 rounded-full pointer-events-none"
                style={{ background: 'radial-gradient(circle, var(--emerald-volumetric), transparent 70%)' }}
                aria-hidden
              />
              <form onSubmit={handleSubmit} className="space-y-8" noValidate>
                <div className="contact-form-grid grid grid-cols-1 sm:grid-cols-2 gap-8">
                  <InputField
                    label="Name"
                    name="name"
                    value={form.name}
                ...
                <div className="contact-submit-row flex flex-wrap items-center gap-6 pt-2">
                  <MagneticButton
                    type="submit"
                    variant="primary"
                  ...
                  {status === 'error' && (
                    ...
                    >
                      ✗ Failed. Email directly at {CONTACT.email}
                    </motion.span>
                  )}
                  </div>
                </div>
